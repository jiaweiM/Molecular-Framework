...
public class Modification {
    ...
    public Modification(ModificationType symbol, int a_iPositionOne, Integer a_iPositionTwo) throws
    ...
    public Modification copy() throws GlycoconjugateException {
        ...
        return new Modification(this.m_enumModification.getName(), this.m_iPositionOne, this
                .m_iPositionTwo);
    }
}

...
public class MassComponents
{
    ...
    public double getModificationMass(ModificationType a_objModi, boolean a_bMonoisotopic, int t_iPositionOne) throws
            GlycoMassException
    {
        double t_dResult = 0;
...
//			}
            ...
            throw new GlycoMassException("Mass calculation for modification " + a_objModi.getName() + " is not " +
                    "supported.");
        }
        return t_dResult;
    }

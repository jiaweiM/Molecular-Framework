...
public class example {
     ...
     */
    public static void main(String[] args) throws ResourcesDbException, SugarImporterException,
            GlycoVisitorException, IOException, InstantiationException, IllegalAccessException,
			ClassNotFoundException, SQLException {
        SugarImporter t_objImporter = new SugarImporterLinucs();
        Config t_objConf = new Config();
        //g1
        String t_strCode = "[][A-D-MANPnac3ac]{[(4+1)][b-D-MANP]{[(4+1)][a-L-MANP]{[(3+1)][b-L-MANP3gc]{}[(3+1)" +
				"][A-D-GLCP3gc]{}}}}";
...
//		 2b:b-dglc-HEX-1:5
        ...
        Connection conn1 = DriverManager.getConnection
				("jdbc:postgresql://zsweb3/glycomedb?user=postgres&password=postgres");

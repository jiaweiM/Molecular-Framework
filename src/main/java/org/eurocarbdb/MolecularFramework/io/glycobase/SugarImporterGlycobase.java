...
public class SugarImporterGlycobase
{
    ...
    public Sugar parse() throws SugarImporterException
    {
        ...
        try {
            ...
            for (String m_aIncrement : this.m_aIncrements) {
                this.m_aResidues.add(this.createResidue(m_aIncrement));
            }
            GlycobaseResidueComparator t_compResidues = new GlycobaseResidueComparator();
            Collections.sort(this.m_aResidues, t_compResidues);
            for (GlycobaseResidue m_aResidue : this.m_aResidues) {
                this.addResidue(m_aResidue);
            }
    ...
    /**
     * @param a_objGlycobaseResidue
     * @throws SugarImporterException
     * @throws GlycoconjugateException
     */
    private void addResidue(GlycobaseResidue a_objGlycobaseResidue) throws SugarImporterException,

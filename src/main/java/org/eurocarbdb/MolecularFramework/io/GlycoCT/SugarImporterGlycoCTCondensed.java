...
public class SugarImporterGlycoCTCondensed extends SugarImporterText {
    ...
    /**
     * "U" "N" "D" <number> ":" <float_number> ":" <float_number> <zeilen_abschluss> "ParentIDs:" <number> { "|"
     * <number> } <zeilen_abschluss> "SubtreeLinkageID" <number> <linkage_type> "(" <number> { "|" <number> } "+"
     * <number> { "|" <number> } ")" <linkage_type> <zeilen_abschluss> <residue_block> <linkage_block>
     *
     * @throws SugarImporterException
     * @throws GlycoconjugateException
     */
    private void underdeterminded_unit() throws SugarImporterException, GlycoconjugateException {
        ...
        // "ParentIDs:" <number> { "|" <number> } <zeilen_abschluss> "SubtreeLinkageID" <number> <linkage_type> "("
        // <number> { "|" <number> } "+" <number> { "|" <number> } ")" <linkage_type> <zeilen_abschluss>
        ...
        while (this.m_cToken == 'S') {
            // "SubtreeLinkageID" <number> <linkage_type> "(" <number> { "|" <number> } "+" <number> { "|" <number> }
            // ")" <linkage_type> <zeilen_abschluss> <residue_block> <linkage_block>
            t_strTemp = "";
    ...
    /**
     * "L" "E" "A" "D" "-" "I" "N" " " "R" "E" "S" ":" <number> <zeilen_abschluss> "L" "E" "A" "D" "-" "O" "U" "T" " "
     * "R" "E" "S" ":" { <number>+<number> "|" } <residue_block> <linkage_block>
     *
     * @param a_objAltUnit
     * @throws SugarImporterException
     * @throws GlycoconjugateException
     */
    private void alternative_graph(SugarUnitAlternative a_objAltUnit) throws SugarImporterException,
        ...
        this.number();
        this.zeilen_abschluss();
        // "L" "E" "A" "D" "-" "I" "N" " " "R" "E" "S" ":" <number> <zeilen_abschluss> "L" "E" "A" "D" "-" "O" "U"
        // "T" " " "R" "E" "S" ":" { <number>+<number> "|" } <residue_block> <linkage_block>
        t_strTemp = "";
    ...
    /**
     * "R" "E" "P" <number> ":" <number> <linkagetype> "(" <number> "+" <number> ")" <number> <linkagetype> "=" <number>
    ...
    private void repeat_unit() throws SugarImporterException, GlycoconjugateException {
        // "R" "E" "P" <number> ":" <number> <linkagetype> "(" <number> "+" <number> ")" <number> <linkagetype> "="
        ...
        this.nextToken();
        // <number> <linkagetype> "(" <number> "+" <number> ")" <number> <linkagetype> "=" <number> "-" <number>
        // <zeilen_abschluss> <residue_block> <linkage_block>
        Linkage t_objLinkage = new Linkage();
        ...
        // "(" <number> "+" <number> ")" <number> <linkagetype> "=" <number> "-" <number> <zeilen_abschluss>
        // <residue_block> <linkage_block>
        if (this.m_cToken != '(') {
            throw new SugarImporterException("GLYCOCTC014", this.m_iPosition);
        }
        ...
        // "+" <number> ")" <number> <linkagetype> "=" <number> "-" <number> <zeilen_abschluss> <residue_block>
        // <linkage_block>
        if (this.m_cToken != '+') {
            throw new SugarImporterException("GLYCOCTC015", this.m_iPosition);
        }

...
public class ErrorTextEng
{
    static public String getErrorText(String a_strCode)
    {
        ...
        t_aTexts.put("LINUCS014", "Unexpected REPEAT : a structure with a REPEAT inside must start with '[][LINK]{[" +
                "(UNTIL+...'");
        t_aTexts.put("LINUCS015", "Unexpected CYCLIC : a structure with a CYCLIC inside must start with '[][LINK]{[" +
                "(UNTIL+...'");
        ...
        t_aTexts.put("BCSDB015", "Unexpected character : side-chain of a multi linkaged residue can only consist of " +
                "one residue");
        ...
        t_aTexts.put("CFG011", "Uncertain subtrees seems to be contacted to be connected to sugar and a repeat unit " +
                "or to two different repeat units.");
        ...
        t_aTexts.put("OGBI021", "Unexpected character : for the two M8 possitions (D1 D2 or D3) two different " +
        ...
        t_aTexts.put("OGBI029", "Unexpected number : positions for Gal must be one position or a list of n positions " +
                "(n=number of Gal).");
        ...
        t_aTexts.put("OGBI036", "Unexpected character : several Gal link position are not allowed for a defined A1 or" +
                " A2 branch.");
        t_aTexts.put("OGBI037", "Unexpected character : only one Gal is allowed for a defined A1 or A2 branch.");
        t_aTexts.put("OGBI038", "Unexpected character : the number of Fucose at Gal residue must be less or equal the" +
                " number of Gal residues.");
        t_aTexts.put("OGBI039", "Unexpected number : number of Fuc at Gal and number of attach position does not " +
                "match.");
        t_aTexts.put("OGBI040", "Unexpected character : the number of sialic acids at Gal residue must be less or " +
                "equal the number of Gal residues.");
        t_aTexts.put("OGBI041", "Unexpected number : number of sialic acid at Gal and number of attach position does " +
                "not match.");
        t_aTexts.put("OGBI042", "Unexpected character : the number of Gal at Gal residue must be less or equal the " +
                "number of Gal residues.");
        t_aTexts.put("OGBI043", "Unexpected number : number of Gal at Gal and number of attach position does not " +
                "match.");
        // glycoCTC
        ...
        t_aTexts.put("GLYCOCTC027", "Unexpected character : duplicated childresidue in 'LEAD-OUT' definition in " +
                "alternative unit.");
        ...
        t_aTexts.put("GLYCOCTC030", "Unexpected character : missing 'SubtreeLinkageID' definition in underdeterminded" +
                " unit.");
        ...
        t_aTexts.put("GLYCOCTC034", "Error in <underDeterminedSubtree>: Tree can only be connected to an repeat unit " +
                "or an sugar.");
        ...
        t_aTexts.put("GLYCOCTC044", "Unexpected character : NON residue can not be attached to the residue. Residue " +
                "still have a parent residue.");

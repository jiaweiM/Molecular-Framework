...
public class SequenceTranslator
{
    ...
    public Sugar translateToGlycoCT(Sugar a_objSugar, MonosaccharideConversion a_objConverter, GlycanNamescheme
            a_objNamespace, boolean a_bStrict) throws GlycoVisitorException
    {
    ...
    public Sugar translateFromGlycoCT(Sugar a_objSugar, MonosaccharideConversion a_objConverter, GlycanNamescheme
            a_objNamespace) throws GlycoVisitorException
    {
    ...
    public Sugar loadSequence(String a_strSequence, SequenceFormat a_objSchema) throws SugarImporterException,
            SequenceFormatException
    {
        ...
        if (a_objSchema == SequenceFormat.GLYCOBASE_LILLE) {
            ...
            ArrayList<String> t_aIncrement = new ArrayList<>();
            Collections.addAll(t_aIncrement, t_aStrings);
    ...
    public String saveSequence(Sugar a_objSugar, SequenceFormat a_objSchema) throws SequenceFormatException,
            SugarExporterException, GlycoVisitorException, IOException
    {
        if (a_objSchema == SequenceFormat.GLYCOCT_CONDENSED) {
